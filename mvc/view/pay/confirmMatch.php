<div class="container">
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin:40px auto;padding:10px; background-color: #9fcdff; text-align: center; border-radius:20px; ">
			...
			<hr>
			<form action="<?=baseUri()?>/user/payMatch" method="post" enctype="multipart/form-data">
				...
				<input type="hidden" name="txt_matchId" value="<?=$match_id?>" class="form-control" />
				<input type="hidden" name="txt_matchName" value="<?=$matchName?>" class="form-control" />
